...
//               <span className="text-green-600 font-bold text-lg">$3,700</span>
...
//             </div>
//             <div className="p-4 bg-gray-50 flex justify-between items-center">
//               <span className="text-green-600 font-bold text-lg">$9,750</span>
...
//             </div>
//             <div className="p-4 bg-gray-50 flex justify-between items-center">
//               <span className="text-green-600 font-bold text-lg">$5,860</span>
...
//               </h3>
//               <p className="text-gray-500 flex items-center">
//                 <FaMapMarkerAlt className="mr-2" /> 5621 Liverpool, Londo
//               </p>
//             </div>
//             <div className="p-4 bg-gray-50 flex justify-between items-center">
//               <span className="text-green-600 font-bold text-lg">$7,540</span>
...
//             </div>
//             <div className="p-4 bg-gray-50 flex justify-between items-center">
//               <span className="text-green-600 font-bold text-lg">$4850</span>
